...
png(filename="plot1.png") #defaults 480x480 pixel image
hist(consume$Global_active_power,xlab="Global Active Power (kilowatts)",main="Global Active Power", col ="red")
dev.off()
