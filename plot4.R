...
png(filename="plot4.png") #defaults 480x480 pixel image
par(mfrow=c(2,2)) #2 by 2 panel of graphs

#Plot 1:
plot(consume$Date_and_Time, consume$Global_active_power, xlab="", ylab="Global Active Power", type="l")

#Plot 2:
plot(consume$Date_and_Time,consume$Voltage,xlab="datetime",ylab="Voltage",type="l")
...
#Plot 4:
plot(consume$Date_and_Time,consume$Global_reactive_power,ylab="Global_reactive_power",xlab="datetime",type="l")
